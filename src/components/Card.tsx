...
const Card: React.FC<ICard> = ({ item, text, handleFunc }) => {
  return (
    <div className="w-3/12 flex flex-col justify-between bg-white rounded-lg">
      <div className="p-4 ">
        <h1 className="text-gray-800 uppercase text-xl line-clamp-1 hover:line-clamp-none">{item.title}</h1>
